...
class StageDebugUP extends FlxState
{
    var player:Player;
    var map:FlxTilemap;
    //###################
...
{
    var tiledData = new TiledMap("assets/data/debug-maps/devmapUP.tmx");
    var layer:TiledTileLayer = cast tiledData.getLayer("tiles");

    FlxG.cameras.bgColor = 0xFF6596FF;
